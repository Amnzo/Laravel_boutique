...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    /// Setting Area
    Route::get('/allorders', 'AdminController@allorders')->name('all_orders');;
    Route::get('/check_order_info/{id}', 'AdminController@orderinfo')->name('more');
    Route::delete('/admin/soft/{id}','AdminController@soft')->name('soft');
